-- Rollback: restore original public matchmaking acceptance behavior.
-- After this rollback, BOTH participants start with accepted_at = NULL.
...
BEGIN
  ...
  -- Original behavior: neither side is pre-accepted.
