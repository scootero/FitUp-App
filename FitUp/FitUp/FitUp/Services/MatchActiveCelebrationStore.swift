//
//  MatchActiveCelebrationStore.swift
//  FitUp
//
//  Persists which active matches already showed the match-live overlay (per profile).
//

import Foundation

enum MatchActiveCelebrationStore {
    private static let defaults = UserDefaults.standard
    private static let maxStoredIds = 100

    private static func storageKey(profileId: UUID) -> String {
        "fitup.matchActiveCelebrationShown.\(profileId.uuidString)"
    }
